...
// this is just a test using int reference parameter, which is not allowed in the assignment, but to confirm with the result
...
int main()
{
    cout << "testing assignment 3 ..." << endl << endl;
